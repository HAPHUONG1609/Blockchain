...
const deployedContracts = {
  31337: {
    ...
    MyUSDEngine: {
      ...
      abi: [
        ...
        {
          inputs: [],
          name: "Engine__InsufficientAllowance",
          type: "error",
        },
        {
          inputs: [],
          name: "Engine__InsufficientBalance",
          type: "error",
        },
        {
          inputs: [],
  ...
  11155111: {
    DEX: {
      address: "0x2DBcd686AAF4f36a0652523806428e008DDA6451",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9963153,
    },
    MyUSD: {
      address: "0xa596D750390517b0C24862D3EA3f2B431d126bFa",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9963152,
    },
    MyUSDEngine: {
      address: "0x7A8CA2B3861107Fd4ADdE498417b20663b5eC1D4",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9963156,
    },
    MyUSDStaking: {
      address: "0x0546Ea6e4851b5B302D888854D5cB83E7D3b5724",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9963155,
    },
    Oracle: {
      address: "0x014Fb1864ac1d91BaA0ebDAeeb935211a3d87D87",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9963154,
    },
    RateController: {
      address: "0xf0D9C803946236D4F1176C7517109E59751Ffe55",
      abi: [
        {
          inputs: [
            {
